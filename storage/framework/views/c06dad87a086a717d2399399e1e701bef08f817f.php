                        ...
                        <span class="d-flex align-items-center">
                            <a href="<?php echo e(route('product', $product->slug)); ?>" class="text-reset d-flex align-items-center flex-grow-1">
                                ...
                                <span class="minw-0 pl-2 flex-grow-1">
                                    ...
                                    <span class=""><?php echo e(single_price($cartItem['price'] + $cartItem['tax'])); ?></span>
                                </span>
                            </a>
                            <span class="">
                                <button onclick="removeFromCart(<?php echo e($cartItem['id']); ?>)" class="btn btn-sm btn-icon stop-propagation">
...
<?php /**PATH C:\xampp\htdocs\Farming_solution\resources\views/frontend/partials/cart.blade.php ENDPATH**/ ?>