...
Route::get('/user_create_blog', 'HomeController@createBlog')->name('customer.blog.create');
Route::post('/user_store_blog', 'HomeController@storeBlog')->name('customer.blog.store');
